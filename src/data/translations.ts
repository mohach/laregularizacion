...
const es: Translation = {
  ...
  blog: {
    ...
    autoUpdated: 'Actualizado automáticamente por IA · Fuentes oficiales verificadas',
...
const en: Translation = {
  ...
  blog: {
    ...
    autoUpdated: 'Auto-updated by AI · Verified official sources only',
...
const ar: Translation = {
  ...
  blog: {
    ...
    autoUpdated: 'تحديث تلقائي بالذكاء الاصطناعي · مصادر رسمية موثقة فقط',
    categoryLabel: 'الفئة',
    trendingTag: '🔥 رائج',
  },
...
const ur: Translation = {
  ...
  blog: {
    ...
    autoUpdated: 'AI کے ذریعے خودکار اپڈیٹ · صرف تصدیق شدہ سرکاری ذرائع',
    categoryLabel: 'زمرہ',
    trendingTag: '🔥 رجحان',
  },
